...
class JoystickImpl : public rrjoy::Joystick_default_impl, public RR::IRRServiceObject
{
protected:
...
public:
    ...
    void force_feedback(const com::robotraconteur::geometry::Vector2& force, double duration);
